  ...
  return (
    <footer className="w-full text-white relative overflow-hidden" style={{backgroundImage: "url('/ourservice background.jpg')", backgroundSize: 'cover', backgroundPosition: 'center'}}>
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-10 left-20 w-24 h-24 border-2 border-white/20 rounded-full"></div>
        <div className="absolute top-40 right-40 w-16 h-16 border-2 border-white/15 rounded-full"></div>
        <div className="absolute bottom-20 left-1/3 w-28 h-28 border-2 border-white/10 rounded-full"></div>
        <div className="absolute top-1/2 right-20 w-12 h-12 border-2 border-white/20 rounded-full"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-10 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col justify-start">
            {/* Logo */}
            <div className="mb-4">
              <img src="/Medagg logo(1).png" alt="Medagg Healthcare" className="h-14 w-auto" />
            </div>
            
            {/* Description */}
            <p className="text-gray-300 leading-relaxed mb-3 max-w-lg text-base md:text-lg">
            ...
            {/* Know More button */}
            <button className="bg-pink-500 hover:bg-pink-600 text-white font-normal text-sm px-8 py-1 rounded-md transition-colors duration-200 mt-2 max-w-[150px] w-full">
              Know More
            </button>
        </div>
          
          {/* Middle section - Quick Links */}
          <div className="lg:col-span-2 flex flex-col justify-start mt-8">
            <h3 className="text-pink-400 font-bold text-base mb-4">Quick Links</h3>
          ...
          <div className="lg:col-span-5 flex flex-col justify-start mt-8">
            <h3 className="text-pink-400 font-bold text-base mb-4">Services</h3>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-4 border-t border-white/10">
          ...
          <div className="mb-2 md:mb-0">
            <span className="text-gray-300 text-xs">Privacy Policy | Terms and Condition</span>
          </div>
