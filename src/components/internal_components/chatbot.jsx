...
const Chatbot = () => {
  ...
  return (
    <div className="fixed bottom-8 right-8 z-50">
      ...
      {/* Chatbot window */}
      {isOpen && (
        <div className="absolute bottom-0 right-0 w-[480px] h-[700px] bg-white rounded-t-3xl shadow-2xl overflow-hidden flex flex-col border border-gray-100 transform transition-all duration-300">
          {/* Header */}
                  ...
                  <div className="flex items-start group">
                    ...
                    <div className="max-w-[90%]">
                      <div className="inline-block px-5 py-4 text-base rounded-2xl bg-white text-gray-800 rounded-tl-none shadow-sm border border-gray-100 group-hover:shadow-md transition-all">
                        ...
                        {activeCondition && message.text.includes(activeCondition) && (
                          <div className="mt-3">
                            <Link 
                              to={`/treatment/${treatments?.find(t => t.condition === activeCondition)?.slug || ''}`}
