...
export default function Trusted_by_Patients_Across_India() {
  return (
    <section className='w-full max-w-7xl mx-auto px-4 py-16 bg-white'>
      ...
      {/* Stats */}
      <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mb-10 bg-white'>
        <div className='bg-white rounded-xl shadow p-8 flex flex-col items-center border border-gray-100 flex-1 min-w-0'>
      ...
      {/* Partner logos */}
      <div className='flex flex-col items-center mb-12 bg-white w-full'>
      ...
      {/* CTA Card */}
      <div className='rounded-xl overflow-hidden shadow-lg w-full max-w-4xl mx-auto mt-10 bg-white flex flex-col'>
          ...
          <div className='relative z-10 flex flex-col items-center justify-center w-full h-full p-6'>
            ...
            <div className='flex flex-col md:flex-row gap-4 items-center justify-center'>
              ...
              <a href='tel:+919363656010' className='border-2 border-white text-white px-6 py-3 rounded-lg font-bold text-base hover:bg-white hover:text-pink-500 transition shadow-md flex items-center gap-2'>
                <svg className='w-5 h-5' fill='none' stroke='currentColor' strokeWidth='2' viewBox='0 0 24 24'><path d='M22 16.92v3a2 2 0 0 1-2.18 2A19.72 19.72 0 0 1 3.08 5.18 2 0 0 1 5 3h3a2 2 0 0 1 2 1.72c.13.81.36 1.6.68 2.34a2 2 0 0 1-.45 2.11L9.1 10.9a16.06 16.06 0 0 0 6.36 6.36l1.73-1.73a2 2 0 0 1 2.11-.45c.74.32 1.53.55 2.34.68A2 2 0 0 1 22 16.92z' /></svg>
                +91 9363656010
              </a>
            </div>
          </div>
